...
# print(a)
# print(a.shape)
img = cv2.imread('/home/kimyongtae/imageprocessing/6.jpg')
...
h_arr = h_arr.astype(np.uint8)
label=np.zeros(h_arr.shape)
for i in range(h_arr.shape[0]):
    for j in range(h_arr.shape[1]):
        if (h_arr[i,j]<125):
            ...
            label[i,j]=1
cv2.imwrite('/home/kimyongtae/imageprocessing/gt_img.jpg',h_arr)
cv2.imwrite('/home/kimyongtae/imageprocessing/gt_label.jpg',label)
